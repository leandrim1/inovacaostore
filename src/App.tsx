    ...
    <AdminAuthProvider>
      <Routes>
        ...
        <Route element={<AdminLayout />}>
          ...
          <Route path="produtos/importar" element={<AdminProductImportPage />} />
          ...
          <Route path="depoimentos" element={<AdminTestimonialsPage />} />
          ...
          <Route path="senha" element={<AdminPasswordPage />} />
