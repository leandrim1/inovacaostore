    ...
    <section className="bg-white py-16 sm:py-24">
      <div className="container-page">
        <SectionHeading
          ...
          action={
            <div className="flex items-center gap-3 border border-brand-ink/10 px-4 py-2.5">
        ...
        <div className="space-y-4">
          {spotlight && (
            <Reveal>
              <figure className="grid gap-5 bg-brand-ink p-8 text-white sm:grid-cols-[auto_1fr] sm:items-center sm:gap-8 sm:p-10">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {rest.map((t, i) => (
              <Reveal key={t.id} delay={i * 0.05}>
                <figure className="flex h-full flex-col justify-between gap-4 border border-brand-ink/10 p-6">
                  <div>
