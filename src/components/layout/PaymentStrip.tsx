 ...
 *
 * Fica sobre o creme, entre as colunas do rodapé e a linha de copyright:
 * é ali que as bandeirinhas brancas ganham contraste sem precisar de borda
 * grossa. Três decisões que separam isso de uma fileira de logos solta:
 *
...
const PASTILHA =
  "flex h-10 w-[58px] shrink-0 snap-start items-center justify-center rounded-[3px] bg-white p-2 ring-1 ring-brand-ink/[0.08]";
...
export function PaymentStrip() {
  ...
  return (
    <div className="border-t border-brand-ink/10 py-7 sm:py-8">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
        {doPainel.length > 0 && (
        <div className="flex min-w-0 flex-col gap-3.5">
          <h3 className="rotulo text-neutral-500">
            Formas de pagamento
          </h3>
        ...
        <div className="flex shrink-0 items-center gap-3.5 self-start rounded-[3px] bg-brand-ink px-5 py-4 lg:self-auto">
          <ShieldCheck size={28} strokeWidth={1.6} className="shrink-0 text-brand-yellow" aria-hidden />
          <div className="flex flex-col gap-0.5">
            <p className="font-display text-base leading-none tracking-[0.06em] text-white">
              Compra 100% segura
            </p>
