  ...
  return (
    ...
    <Tilt3D className="h-full rounded-2xl" max={6} sombra pausado={isPicking}>
      <motion.article
        ...
        className={`group relative flex h-full flex-col overflow-hidden rounded-2xl border border-brand-ink/10 bg-white transition-colors duration-300 hover:border-brand-ink/25 ${
          inclinacao ? "" : "hover:shadow-[0_24px_48px_-28px_rgba(0,0,0,0.35)]"
        }`}
      >
        <Link
