 ...
 * dedo e a inclinação do celular por poucos centímetros. Movimentos
 * pequenos de propósito — a cena nunca "balança".
 */
export function CameraController({
  ...
  useFrame((state, delta) => {
    ...
    const y = base[1] + gy * 0.18;
    const distancia = base[2] / z;
